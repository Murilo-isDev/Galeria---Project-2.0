 ...
 let imagens = ['/imagens/brasil.png','/imagens/barcelona.png', '/imagens/city.png', '/imagens/liverpool.png', '/imagens/allnasser.png', '/imagens/borussia.png', '/imagens/psg.png'];
 let imAtual = 0;
